...
final class ShortCode {
	...
	public function r2_slider_banner_shortcode_callback() {
		...
		if ( \have_rows( 'banner_swiper' ) ) :
			echo '<div class="swiper r2-slider r2-banner">';
	...
	public function r2_slider_comment_shortcode_callback() {
		...
		if ( \have_rows( 'comment_swiper' ) ) :
			echo '<div class="swiper r2-comment r2-slider !px-16 sm:!px-0 sm:!pt-20">';
			echo '<div class="swiper-wrapper">';
			// Loop through rows.
			...
			endwhile;
			echo '</div>';
			echo '<div class="swiper-controller-wrap hidden sm:!flex space-x-5 items-center absolute right-0 top-0 z-20 py-1 px-2">';
			echo '<div class="swiper-button-prev"></div>';
			echo '<div class="swiper-button-next"></div>';
			echo '<div class="swiper-pagination"></div>';
			echo '</div>';
