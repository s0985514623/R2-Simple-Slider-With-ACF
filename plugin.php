 ...
 * Text Domain:       r2-simple-slider-with-acf
 * Domain Path:       /languages
 * Tags: acf repeater, slider, carousel
 */
...
if ( ! \class_exists( 'R2\SimpleSlider\Plugin' ) ) {
	...
	final class Plugin {
		...
		const APP_NAME    = 'Simple Slider With ACF';
		const KEBAB       = 'simple-slider-with-acf';
		const SNAKE       = 'simple_slider_with_acf';
		const GITHUB_REPO = 'https://github.com/s0985514623/R2-Simple-Slider-With-ACF';
		...
		public function register_required_plugins(): void {
			...
			$config = array(
				...
				'dismiss_msg'  => __( '這個訊息將在依賴套件被安裝並啟用後消失。' . Plugin::APP_NAME . ' 沒有這些依賴套件的情況下將無法運作！', 'Advanced Custom Fields PRO' ), // If 'dismissable' is false, this message will be output at top of nag.
